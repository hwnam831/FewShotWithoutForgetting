...
config["max_num_epochs"] = 45

networks = {}
net_optionsF = {"userelu": False, "in_planes": 3, "dropout": 0.5}
pretrainedF = (
    "./experiments/miniImageNet_ResNetLikeNAM/feat_model_net_epoch*.best"
)
networks["feat_model"] = {
...
pretrainedC = (
    "./experiments/miniImageNet_ResNetLikeNAM/classifier_net_epoch*.best"
)
net_optionsC = {
    "classifier_type": "cosine",
    "weight_generator_type": "namattention",
    "nKall": nKbase,
    "nFeat": 512,
    "scale_cls": 10,
    "scale_att": 10.0,
